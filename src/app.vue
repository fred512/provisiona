...
const blankTemplate = () => ({ id: null, title: '', category: 'Moradia', frequency: 'monthly', dueDay: 10, anchorMonth: currentMonthValue(), nominalAmount: null, payerName: '', sourceChannel: 'Gmail', sender: '', locatorHint: '', paymentMethod: 'Boleto', bankAccount: 'Nubank', active: true })
